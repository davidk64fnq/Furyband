...
GLOBELIGHT2 = add_spell
{
	...
	["fail"] = 	10,
	["spell"] = 	function()
			return fire_wave(GF_LITE, 0, 80 + get_level(GLOBELIGHT2, 200), 1 + get_level(GLOBELIGHT2, 3, 0), 20 + get_level(GLOBELIGHT2, 70), EFF_STORM)
	...
	["desc"] =	{
			"Carries a large light-storm around with you",
			}
