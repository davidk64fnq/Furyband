...
ingame_help
{
	...
	["desc"] =
	{
		"Welcome to FuryBand! I am the spirit of knowledge and my task is to help you",
...
ingame_help
{
	...
	["fct"] =       function(typ, name)
			...
			local t =
			{
				...
				["subrace"] =
				{
					["2 headed-Hydra"] = { "r_2_headed_hydra.txt", 0 },
					["Acid"] = {"rm_acid.txt", 0 },
					...
					["Basilisk"] = { "rm_basilisk.txt", 0 },
					["Black"] = {"rm_black.txt", 0 },
					["Black"] = {"rm_black(s).txt", 0 },
					["Blessed"] = {"rm_blessed.txt", 0 },
					["Blue"] = {"rm_blue.txt", 0 },
					["Blue"] = {"rm_blue(s).txt", 0 },
					["Catoblepas"] = { "rm_catoblepas.txt", 0 },
					...
					["Ettin"] = { "rm_ettin.txt", 0 },
					["Eye Druj"] = { "rm_eye_druj.txt", 0 },
					...
					["Nightwalker"] = { "rm_nightwalker.txt", 0 },
					...
					["White"] = { "rm_white(s).txt", 0 },
					["Wraith"] = { "rm_wraith(s).txt", 0 },
					["Xorn"] = { "rm_xorn.txt", 0 },
				...
				["class"] =
				{
					...
					["Ammoless archer"] = { "c_ammol.txt", 0 },
					["Air Warrior"] = { "c_airwar.txt", 0 },
					["Archer"] = { "c_archer.txt", 0 },
					["Ascetic"] = { "c_ascet.txt", 0 },
					["Assassin"] = { "c_assass.txt", 0 },
					["Axemaster"] = { "c_axemas.txt", 0 },
					["Bard"] = { "c_bard.txt", 0 },
                         	        ["BeastMaster"] = { "c_beastmaster.txt", 0 },
                         	        ["Berserker"] = { "c_berserker.txt", 0 },
					["Boulder-hurler"] = { "c_boulder.txt", 0 },
                       		        ["Bowman"] = { "c_bowman.txt", 0 },
					["Crossbowman"] = {"c_crossbow.txt", 0},
					["Dark-Priest"] = { "c_pr_drk.txt", 0 },
					["Death Warrior"] = { "c_deathwar.txt", 0 },
					["Druid"] = { "c_druid.txt", 0 },
					["Earth Warrior"] = { "c_earthwar.txt", 0 },
					["Energy Warrior"] = { "c_energywar.txt", 0 },
                        	        ["Fire Warrior"] = { "c_firewar.txt", 0 },
					["Geomancer"] = { "c_geoman.txt", 0 },
					["Haftedmaster"] = { "c_hafted.txt", 0 },
					["Hunter"] = { "c_hunter.txt", 0 },
                    	                ["Jedi"] = { "c_jedi.txt", 0 },
					["Loremaster"] = { "c_lorema.txt", 0 },
					["Mage"] = { "c_mage.txt", 0 },
                            	        ["Maia-lore"] = { "c_maial.txt", 0 },
				        ["Master"] = { "c_master.txt", 0 },
					["Mercenary"] = { "c_mercen.txt", 0 },
					["Merchant"] = { "c_merch.txt", 0 },
					["Mimic"] = { "c_mimic.txt", 0 },
					["Mindcrafter"] = { "c_mindcr.txt", 0 },
					["Monk"] = { "c_monk.txt", 0 },
					["Movement Warrior"] = { "c_movewar.txt", 0 },
					["Nature Warrior"] = { "c_naturewar.txt", 0 },
					["Ninja"] = { "c_ninja.txt", 0 },
					["Pacifist"] = { "c_pacif.txt", 0 },
					["Paladin"] = { "c_palad.txt", 0 },
					["Peace-mage"] = { "c_peacemag.txt", 0 },
					["Phase-Warrior"] = { "c_phasew.txt", 0 },
					...
					["Water Warrior"] = { "c_waterwar.txt", 0 },
					["Wise Warrior"] = { "c_wisewar.txt", 0 },
